...
function pathValidation(source, target, callback, db) {
    ...
    var options = {
        hostname : "http://contentcatalog:mL1CSF2PKYTtPkGMdRnv@hobby-hhimaappojekgbkebdhlnhol.dbs.graphenedb.com:24789/db/data",
